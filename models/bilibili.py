...
class BilibiliUser(models.database.OrmBase):
    ...
    accompany: Mapped[int] = mapped_column(sqlalchemy.BigInteger)
    accompany_updateTime: Mapped[datetime.datetime]
    uname: Mapped[str] = mapped_column(sqlalchemy.String(100))
